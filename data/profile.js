  ...
  experiences: [
    {
      ...
      active:   true,
      desc:     "针对心血管疾病诊断中数据模态复杂、异构性强的痛点，以多模态大模型为认知中枢，创新性地开发和集成多种专业工具。同时引入多专家协同架构，使智能体具备类医生的"慢思考"能力，能够精准识别数据模态并自主规划最优诊疗路径，实现从感知、推理到临床决策的端到端闭环。",
  ...
  leadership: [
    {
      ...
      title:    "研究生第一党支部书记",
      org:      "陕西科技大学",
      desc:     "以思想建设为引领，不断淬炼支部党员的党性修养。2022年被推选为中共陕西科技大学第三次代表大会全校12名学生代表之一（学院唯一），展现出青年党员的责任与担当。2023年党支部获评校级"研究生优秀党支部"（学院唯一）。",
      highlights: ["全校12名学生代表之一（学院唯一）", "党支部获评"研究生优秀党支部""],
    },
    {
      period:   "2021.09 — 2024.06",
      title:    "研21级大班长",
    ...
    },
    {
      ...
      title:    "研究生辅导员助理",
      org:      "陕西科技大学",
      desc:     "以热情洋溢的态度，积极参与学院学生工作，搭建学生与学院之间的桥梁，成为学生们的良师益友。先后荣获校级"优秀团干"、"优秀研究生干部"、"先进个人"等荣誉称号。",
      highlights: ["获"优秀团干"、"优秀研究生干部"、"先进个人""],
    },
    {
