...
熟悉机器学习、深度学习等常用框架与算法，目前担任 <strong>IEEE JBHI、Neurocomputing、Neural Networks、IET Image Processing等期刊审稿人</strong>、<strong>Frontiers in Signal Processing 期刊客座副主编</strong>。`,
  ...
  news: [
    ...
    { date: "2025-04", type: "其他",  content: "<strong>国家主席习近平</strong>来上海市调研人工智能发展，与其面对面交谈，<strong>并登上央视新闻联播</strong>" },
  ...
  leadership: [
    ...
    },
    {
      ...
      title:    "研究生第一党支部书记",
      org:      "陕西 · 西安",
      desc:     "以思想建设为引领，不断淬炼支部党员的党性修养。2022年被推选为学校第三次党员代表大会全校12名学生代表之一（学院唯一），展现出青年党员的责任与担当。2023年党支部获评校级研究生优秀党支部（学院唯一）。",
